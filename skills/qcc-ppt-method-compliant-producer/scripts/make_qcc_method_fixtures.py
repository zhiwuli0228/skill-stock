...
def build_data_complete(path: Path) -> None:
    ...
    add_text_slide(
        ...
        "解析｜真因验证",
        [
            "真因验证：要因1 校验规则缺失。数据来源：查检表 300 例 + 现场记录。",
            "验证方法：对 300 例异常按规则缺失分类统计。",
            "验证结果：规则缺失关联异常 98 例（占异常 77.8%）。",
            "结论：成立（真因）；未通过项（抽样标准）回退至下一轮分析。",
        ],
    )
    ...
    add_text_slide(
        ...
        "标准化",
        [
            "标准化文件名称：《结果校验作业标准书》，编号 QCC-STD-001，类型：作业标准书。",
            "日常稽核：责任人张三，每月 1 次，按检查表逐项稽核。",
